...
public class Delivery {
    ...
    public Delivery(QueueThreadSafe<Order> deliveryOrders, QueueThreadSafe<Order> doneOrders, Stockpile stockpile) {
    ...
    public void addDeliveryMan(DeliveryMan deliveryMan) {
        threads.add(new Thread(new DeliveryManThread(deliveryMan, deliveryOrders, doneOrders, stockpile)));
    }
